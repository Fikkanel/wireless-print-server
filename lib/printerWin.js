...
async function printPdfWithWinRT(absPath, targetPrinter, options = {}) {
  ...
  if (result.ok) {
    return 'Dokumen PDF berhasil dikirim langsung ke antrian cetak printer.';
  }
...
module.exports = { getStatus, getCapabilities, getInstalledPrinters, printFile, writeDebugLog };
